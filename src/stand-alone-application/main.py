...
def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/",title = "Select a directory")
...
def main():
	...
	#-------------------------Select a file----------------------
	inputEncFile = Label(EncryptStep, text="Select a File:")
